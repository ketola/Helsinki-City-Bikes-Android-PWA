...
const Station = (props) => (
  <div className='bike-station'>
    ...
    <div className='distance'>Distance: {location && geolib.getDistance( {latitude: props.geoposition.coords.latitude, longitude: props.geoposition.coords.longitude}, {latitude: props.station.y, longitude: props.station.x})} m</div>
  </div>
)
